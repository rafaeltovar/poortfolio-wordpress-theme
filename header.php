...
<title><?php
  ...
  if ( $paged >= 2 || $page >= 2 )
    echo ' | ' . sprintf( __( 'Page %s', 'poortfolio' ), max( $paged, $page ) );
...
<header>
	...
	<div id="menu-area" class="row">
		<div class="large-9 columns">		
			<nav>
				<section>
					<?php wp_nav_menu( array( 'theme_location' => 'header-menu', 'menu_class' => 'left', 'container' => '', 'fallback_cb' => 'foundation_page_menu', 'walker' => new poortfolio_navigation() ) ); ?>
				</section>
			</nav>
		</div>
